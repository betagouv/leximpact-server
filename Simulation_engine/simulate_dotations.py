...
TABLE_LEXIMPACT_TO_OFDL = {
    ...
    "dotations.communes.dsu.attribution.effortFiscalLimite": "dotation_solidarite_urbaine.eligibilite.attribution.plafond_effort_fiscal",
    "dotations.communes.dsu.attribution.facteurClassementMax": "dotation_solidarite_urbaine.eligibilite.attribution.facteur_classement_max",
    "dotations.communes.dsu.attribution.facteurClassementMin": "dotation_solidarite_urbaine.eligibilite.attribution.facteur_classement_min",
    "dotations.communes.dsu.attribution.poidsSupplementaireZoneUrbaineSensible": "dotation_solidarite_urbaine.eligibilite.attribution.poids_quartier_prioritaires_ville",
    "dotations.communes.dsu.attribution.poidsSupplementaireZoneFrancheUrbaine": "dotation_solidarite_urbaine.eligibilite.attribution.poids_zone_franche_urbaine",
    "dotations.communes.dsu.attribution.augmentationMax": "dotation_solidarite_urbaine.eligibilite.attribution.augmentation_max",
