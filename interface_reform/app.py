...
API_mode = False #If true, the app will attempt to retrieve data through an API call rather than through Openfisca.
...
app.layout = html.Div(
    [
        ...
        ) if not version_beta_sans_graph_pop else html.B(""),
        html.Div(
            [
                ...
                html.Div(
                    ...
                    ] if not version_beta_sans_graph_pop else []),
